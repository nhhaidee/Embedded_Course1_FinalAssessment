...
void course1(void) 
{
  ...
  PRINTF("--------------------------------\n");
  PRINTF("Test Results:\n");
  printf ("test_data1 Result: %d\n",results[0]);
  printf ("test_data2 Result: %d\n",results[1]);
  printf ("test_memmove1 Result: %d\n",results[2]);
  printf ("test_memmove2 Result: %d\n",results[3]);
  printf ("test_memmove3 Result: %d\n",results[4]);
  printf ("test_memcopy Result: %d\n",results[5]);
  printf ("test_memset Result: %d\n",results[6]);
  printf ("test_reverse Result: %d\n",results[7]);
