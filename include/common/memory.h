 ...
 *   The behavior is undefined if there is overlap of source and destination. Copy should still occur, but will likely corrupt  data.
 *   All operations need to be performed using pointer arithmetic, not array indexing
 *   Return a pointer to the destination (dst).
 *
 * @param src Pointer to source
 ...
 *
 * @param src Pointer to source
 * @param length a elngth in byte
 * @param value value to set
 *
 * @return Pointer with values are set
 */
uint8_t * my_memset(uint8_t * src, size_t length, uint8_t value);

/**
 * @brief Set memory function with all zero
 *
 ...
 *
 * @param src Pointer to source
 * @param length a length in byte
 *
 * @return Pointer with all zero
 */
uint8_t * my_memzero(uint8_t * src, size_t length);

/**
 * @brief Reverse the order of arrray
 *
 ...
 * @param length a length in byte
 *
 * @return Pointer with reverse order
 */
...
/**
 * @brief Free Memory allocation function
 *
 *   This should take number of words to allocate in dynamic memory
 *  All operations need to be performed using pointer arithmetic, not array indexing
 *  Should return a pointer to memory if successful, or a Null Pointer if not successful
